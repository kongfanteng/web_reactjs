...
### 1.4 增加 React 标签-IndeterminateComponents-[src/react-reconciler/src/ReactWorkTags.js](../../public/react18-learn/src/react-reconciler/src/ReactWorkTags.js)
...
```js
import { HostRoot, IndeterminateComponents, HostComponent } from './ReactWorkTags'
// ...
...
### 4.4 判断是否是文本独生子-创建-shouldSetTextContent-[src/react-dom-bindings/src/ReactDOMHostConfig.js](../../public/react18-learn/src/react-dom-bindings/src/ReactDOMHostConfig.js)
