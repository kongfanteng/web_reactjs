...
```js
import { Nolanes, markRootUpdated } from './ReactFiberLane'
...
### 4.5 getNextLanes-获取当前优先级最高的车道-[src/react-reconciler/src/ReactFiberWorkLoop.js](../../public/react18-learn/src/react-reconciler/src/ReactFiberWorkLoop.js)
...
export function lanesToEventPriority(lanes) {
  // 获取最高优先级的 lane
  let lane = getHighestLaneFromLanes(lanes)
...
### 5.3 includesNonIdleWork-判断是否包含 NonIdleWork-[src/react-reconciler/src/ReactFiberLane.js](../../public/react18-learn/src/react-reconciler/src/ReactFiberLane.js)

```js
/**
 * description: 判断是否包含 NonIdleWork
 */
export function includesNonIdleWork(lanes) {
  return (lanes & NonIdleWork) !== NoLanes
}
```
